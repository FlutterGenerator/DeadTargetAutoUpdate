...
public class Menu {
    ...
    int MENU_BG_COLOR = Color.parseColor("#FF262927"); //#AARRGGBB
    int MENU_FEATURE_BG_COLOR = Color.parseColor("#FF262927"); //#AARRGGBB
    int MENU_WIDTH = 290;
    int MENU_HEIGHT = 210;
    int POS_X = 0;
    int POS_Y = 100;
    ...
    int ToggleON = Color.GRAY;
    int ToggleOFF = Color.WHITE;
    int BtnON = Color.parseColor("#1b5e20");
    int BtnOFF = Color.parseColor("#7f0000");
    int CategoryBG = Color.parseColor("#FF706F6F");
    int SeekBarColor = Color.parseColor("#FF706F6F");
    int SeekBarProgressColor = Color.parseColor("#FF706F6F");
    int CheckBoxColor = Color.parseColor("#FF706F6F");
    ...
    public Menu(Context context) {
        ...
        gdMenuBody.setStroke(1, Color.parseColor("#FF4D0000")); //Set border
        ...
        for (int i = 0; i < listFT.length; i++) {
            ...
            switch (strSplit[0]) {
                ...
                case "Spinner":
                    ...
                    break;
                case "InputText":
                    TextField(linearLayout, featNum, strSplit[1], false, 0);
                    break;
                case "InputValue":
                    if (strSplit.length == 3)
                        TextField(linearLayout, featNum, strSplit[2], true, Integer.parseInt(strSplit[1]));
                    if (strSplit.length == 2)
                        TextField(linearLayout, featNum, strSplit[1], true, 0);
                    break;
                case "CheckBox":
    ...
    private void TextField(LinearLayout linLayout, final int featNum, final String featName, final boolean numOnly, final int maxValue) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //LinearLayout
                LinearLayout linearLayout1 = new LinearLayout(getContext.getApplicationContext());
                linearLayout1.setPadding(5, 5, 5, 5);
                linearLayout1.setOrientation(LinearLayout.VERTICAL);
                linearLayout1.setBackgroundColor(MENU_FEATURE_BG_COLOR);

                //TextView
                final TextView TextViewNote = new TextView(getContext.getApplicationContext());
